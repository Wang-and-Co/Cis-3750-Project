...
export const Primary = () => (
    <EventDescription
      ...
      event={{
        ...
        description: 'Come out and test your track racing ability! Riders with a UCI Track Cycling license and race certifications are eligible to participate in NCIM race nights which consist of sprint-specific nights, bunch racing, and even timed events.',
